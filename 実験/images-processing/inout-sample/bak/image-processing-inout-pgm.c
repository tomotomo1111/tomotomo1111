...
int main(void){
  ...
  printf("Please input the file name of the input pgm image :  "); 
 ...
 printf("Please input the file name of the output pgm image:  "); 
